...
public class PathUtil
{
    ...
    {
        string path = string.Format("{0}/res/GameAB/{1}/{2}", persistentDataPath, PlatformName, assetBundleName);

        //if (!File.Exists(path))
        //{
        //    path = string.Format("{0}/res/GameAB/{1}/{2}", Application.streamingAssetsPath, PlatformName, assetBundleName);
        //}
    ...
    public static void Decode(byte[] data)   // dummy
    {
